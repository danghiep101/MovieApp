...
class TvShowsViewModel(private val movieRepository: MovieRepository = MovieRepositoryImp()): ViewModel() {
    ...
    fun loadTvShows() {
        ...
        viewModelScope.launch {
            val result = movieRepository.getTvShows(currentPage, limit)
