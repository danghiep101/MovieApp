...
class MovieSeriesViewModel(private val movieRepository: MovieRepository = MovieRepositoryImp()) :ViewModel() {
    private val _movies = MutableLiveData<List<Item>?>()
    val movie: LiveData<List<Item>?> = _movies
    ...
    fun loadMovieSeries() {
        ...
        viewModelScope.launch{
            val result = movieRepository.getMovieSeries(currentPage, limit)
